...
{{--                <div class="sidebar-brand-text mx-3">SB Admin <sup>2</sup></div>--}}
                <div class="sidebar-brand-text mx-3">Guy Jewelry Admin</div>
            </a>
...
{{--                                        <img class="rounded-circle" src="images/admin/undraw_profile_1.svg"--}}
{{--                                             alt="...">--}}
                                        <img class="rounded-circle" src="/images/logo/guy_jewelry_logo.png"/>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="images/admin/undraw_profile_2.svg"
                                             alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="images/admin/undraw_profile_3.svg"
                                             alt="...">
