...
{{--                                                                   href="https://datatables.net">official DataTables documentation</a>.</p>--}}
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">메인 카테고리</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @if(count($lookbook_main_category_list) > 0)
                            @foreach($lookbook_main_category_list as $lookbook_main_category)
                                <tr>
                                    <td>
                                        {{$lookbook_main_category->id}}
                                    </td>
                                    <td>{{$lookbook_main_category->lookbook_main_category_name}}</td>
                                    <td>
                                        <img src="{{$lookbook_main_category->lookbook_main_category_image}}" alt="" style="width: 300px;">
                                        <span>{{$lookbook_main_category->lookbook_main_category_image}}</span>
                                    </td>
                                    <td>{{$lookbook_main_category->created_at}}</td>
                                    <td>
                                        @if($lookbook_main_category->del_yn == "N")
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">메인 카테고리 등록</h5>
    ...
    <div class="modal fade" id="lookbook_update_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">메인 카테고리 수정</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="update_categoryFrm">
                        <input type="hidden" class="lookbook_main_category_id" name="lookbook_main_category_id">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <colgroup>
                                <col style="width: 20%;">
                                <col style="width: 80%;">
                            ...
                            <tr>
                                <th>카테고리명</th>
                                <td>
                                    <input type="text" class="form-control input-group update_name" id="lookbook_main_category_name" name="lookbook_main_category_name" value="">
                                </td>
                            </tr>
                            <tr>
                                <th>
                ...
                <div class="modal-footer">
                    <div class="w-100">
                        <button type="button" class="btn btn-default" data-dismiss="modal">취소</button>
                        <button type="button" class="btn btn-primary float-right btn_update_main_category">수정</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(".btn_delete_main_category").on("click", function(){
