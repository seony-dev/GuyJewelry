                    ...
                    <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url('/images/shop/watchring.gif');">
                        <div class="titan-caption">
                            <div class="caption-content">
                                ...
                                <div class="font-alt mb-40 titan-title-size-4">가이 주얼리</div>
{{--                                <a class="section-scroll btn btn-border-w btn-round" href="#latest">Learn More</a>--}}
                            </div>
                        </div>
                    </li>
...
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-7.jpg" alt="Accessories Pack"/>--}}
...
{{--                        <div class="col-sm-6 col-md-3 col-lg-3">--}}
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-8.jpg" alt="Men’s Casual Pack"/>--}}
{{--                                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
{{--                                </div>--}}
...
{{--                        <div class="col-sm-6 col-md-3 col-lg-3">--}}
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-9.jpg" alt="Men’s Garb"/>--}}
{{--                                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
{{--                                </div>--}}
...
{{--                        <div class="col-sm-6 col-md-3 col-lg-3">--}}
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-10.jpg" alt="Cold Garb"/>--}}
{{--                                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
{{--                                </div>--}}
...
{{--                        <div class="col-sm-6 col-md-3 col-lg-3">--}}
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-11.jpg" alt="Accessories Pack"/>--}}
{{--                                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
{{--                                </div>--}}
{{--                                <h4 class="shop-item-title font-alt"><a href="#">Accessories Pack</a></h4>£9.00--}}
{{--                            </div>--}}
...
{{--                        <div class="col-sm-6 col-md-3 col-lg-3">--}}
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-12.jpg" alt="Men’s Casual Pack"/>--}}
{{--                                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
{{--                                </div>--}}
{{--                                <h4 class="shop-item-title font-alt"><a href="#">Men’s Casual Pack</a></h4>£12.00--}}
{{--                            </div>--}}
...
{{--                        <div class="col-sm-6 col-md-3 col-lg-3">--}}
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-13.jpg" alt="Men’s Garb"/>--}}
{{--                                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
{{--                                </div>--}}
{{--                                <h4 class="shop-item-title font-alt"><a href="#">Men’s Garb</a></h4>£6.00--}}
{{--                            </div>--}}
...
{{--                        <div class="col-sm-6 col-md-3 col-lg-3">--}}
{{--                            <div class="shop-item">--}}
{{--                                <div class="shop-item-image"><img src="/images/shop/product-14.jpg" alt="Cold Garb"/>--}}
{{--                                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
{{--                                </div>--}}
{{--                                <h4 class="shop-item-title font-alt"><a href="#">Cold Garb</a></h4>£14.00--}}
{{--                            </div>--}}
...
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="ex-product"><a href="#"><img src="/images/shop/product-1.jpg" alt="Leather belt"/></a>--}}
...
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="ex-product"><a href="#"><img src="/images/shop/product-2.jpg" alt="Derby shoes"/></a>--}}
...
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="ex-product"><a href="#"><img src="/images/shop/product-3.jpg" alt="Leather belt"/></a>--}}
...
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="ex-product"><a href="#"><img src="/images/shop/product-4.jpg" alt="Leather belt"/></a>--}}
...
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="ex-product"><a href="#"><img src="/images/shop/product-5.jpg" alt="Chelsea boots"/></a>--}}
...
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="ex-product"><a href="#"><img src="/images/shop/product-6.jpg" alt="Leather belt"/></a>--}}
{{--                                        <h4 class="shop-item-title font-alt"><a href="#">Leather belt</a></h4>£19.00--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="client-logo"><img src="/images/client-logo-dark-1.png" alt="Client Logo"/></div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="client-logo"><img src="/images/client-logo-dark-2.png" alt="Client Logo"/></div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="client-logo"><img src="/images/client-logo-dark-3.png" alt="Client Logo"/></div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="client-logo"><img src="/images/client-logo-dark-4.png" alt="Client Logo"/></div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
{{--                                    <div class="client-logo"><img src="/images/client-logo-dark-5.png" alt="Client Logo"/></div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="owl-item">--}}
{{--                                <div class="col-sm-12">--}}
